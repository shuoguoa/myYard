    ...
    <div class="container">
        <div class="row row-offcanvas row-offcanvas-right">
            <div class="col-xs-12 col-sm-9">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{url('/web/noteinsert')}}">
                    <div class="form-group">
                        <label class="col-md-4 control-label">笔记标题</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="title" value="{{old('title')}}" id="inputEmail3" placeholder="text">
                        </div>
                    </div>
