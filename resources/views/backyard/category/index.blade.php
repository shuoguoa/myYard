    ...
    <div class="container">
        <div class="row row-offcanvas row-offcanvas-right">
            <div class="col-xs-12 col-sm-9">
                ...
                <h3>笔记类别信息列表</h3>
                <button type="button" class="btn btn-primary" data-toggle="offcanvas" onclick="window.location='/web/categoryadd'">
                    添加分类</button>
            ...
            onclick=\"window.location='/web/noteslist/{$vo['id']}\">浏览笔记</button></td>";
                            echo "<td><button type=\"button\"  class=\"btn btn-primary\"
            onclick=\"window.location='/web/deletecat/{$vo['id']}\">删除分类</button></td>";
